...
def choose_onsets(durartion_min, n=5, t=5, start=30, end=10):
    """
    int durartion_min: length of recording in minutes
    int n: number of random segments to choose
    int t: length of region of interest (including context)
    int start: minute at which
    """
    minute_range = list(range(start, min(durartion_min - t, durartion_min - end)))
